...
| (pending) s12-ui-05 — SlotReel slot-frame + BattleScreen win-burst → Pixi.Graphics (3-stroke ornate frame + 4 corner dots; concentric circles + 12 radial rays for win burst) | [`sprint12/s12-ui-05-reel-frame-and-winburst.md`](sprint12/s12-ui-05-reel-frame-and-winburst.md) | **ready to dispatch** — skill hints: code-simplification, incremental-implementation, source-driven-development |
