...
| (next) chore — Formation 2-row clash zone clearance. Replace 3-row NineGrid 5-of-9 Fisher-Yates with deterministic 2-row layout (back-3 + front-2 col-1-empty). Grid edges pulled outward (32→16 / 400→416), centre clash gap 80→152px (1.9× wider, ±70 attack avatars no longer overlap formation). 3 atomic commits + pre-merge audit checklist | [`chore/formation-2row-clash-zone.md`](chore/formation-2row-clash-zone.md) | dispatch ready |
