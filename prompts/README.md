...
| (next) chore — AUTO button real feature (spin count selector popup 10/25/50/100 + event-driven autoSpinsRemaining replaces setInterval + stop on FreeSpin/JP/match-end + active-state STOP N display) | [`chore/auto-spin-feature.md`](chore/auto-spin-feature.md) | dispatch ready |
