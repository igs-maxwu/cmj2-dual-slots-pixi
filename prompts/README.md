...
| (chore #211) Re-enable curse weight 0→3 (chore Path L disable lift). Owner trial 2026-05-05 to validate chore #209 詛咒發動 banner visual. Direct commit master 38789ef | [`chore/re-enable-curse-weight-for-banner-trial.md`](chore/re-enable-curse-weight-for-banner-trial.md) | ✅ merged |
