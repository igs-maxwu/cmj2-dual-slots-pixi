...
| (pending) s12-ui-03 — UiButton component rewrite (Sprite + 2 webp → Pixi.Graphics gradient + border + hitArea Rectangle; kill dead 'ornate' variant code path) | [`sprint12/s12-ui-03-uibutton-rewrite.md`](sprint12/s12-ui-03-uibutton-rewrite.md) | **ready to dispatch** — skill hints: code-simplification, incremental-implementation, source-driven-development |
