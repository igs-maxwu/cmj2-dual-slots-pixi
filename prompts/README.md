...
| (next, hotfix) chore — SlotReel inline highlight match shape (chore #202 audit miss). DraftScreen GemSymbol component was fixed but SlotReel inline highlight still ellipse. Apply same polygon facet branch | [`chore/slotreel-highlight-shape-match.md`](chore/slotreel-highlight-shape-match.md) | dispatch ready |
