...
| (next) chore — STRICT mercenary removal + damage alive-gate (mechanic SPEC change owner-approved 2026-05-04). SlotEngine drops mercenary wayHit early-continue (no coin, no dmg, no reel trace). Drafted hit dmg gated on matching alive spirit (coin unchanged). Wild ×2 preserved. **RTP impact ~30% downgrade — sim verification post-merge** | [`chore/attack-strict-mercenary-and-alive-gate.md`](chore/attack-strict-mercenary-and-alive-gate.md) | dispatch ready |
