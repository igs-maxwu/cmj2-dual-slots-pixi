...
| (pending) s12-ui-04 — SpiritPortrait rewrite (portrait-ring webp → Graphics clan-aware ring per mockup SpiritToken — azure/white/vermilion/black clan colors, special symbols use gold/purple/pink) | [`sprint12/s12-ui-04-spirit-portrait-rewrite.md`](sprint12/s12-ui-04-spirit-portrait-rewrite.md) | **ready to dispatch** — skill hints: code-simplification, incremental-implementation, source-driven-development |
