...
| (next) chore — UiButton aesthetic upgrade. FillGradient 3-stop + outer dark stroke + inner gold hairline + top highlight + 4 corner accent dots + drop shadow. JP marquee style. Affects DraftScreen 4 toolbar + START BATTLE buttons | [`chore/ui-button-aesthetic-upgrade.md`](chore/ui-button-aesthetic-upgrade.md) | dispatch ready |
