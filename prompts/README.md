...
| (pending) s12-ui-06 — Final cleanup (delete 2 UI webp + 5 gem-shape webp + GemMapping.ts dead file + LoadingScreen drop preloadUi/preloadGems + UI_ASSET_KEYS empty) — **Sprint 12 closure PR** | [`sprint12/s12-ui-06-final-cleanup.md`](sprint12/s12-ui-06-final-cleanup.md) | **ready to dispatch** — skill hints: code-simplification, incremental-implementation, source-driven-development |
