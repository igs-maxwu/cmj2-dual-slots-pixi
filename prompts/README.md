...
| (next) chore — SYMBOL_VISUAL redesign (last-char per spirit + same-clan color + W/S/JP specials + Curse weight 3→0 Path L). 8 spirit unique chars 寅/鸞/雨/璋/嵐/洛/羽/墨; charText fontSize conditional for 2-char JP fit | [`chore/symbol-visual-redesign-last-char.md`](chore/symbol-visual-redesign-last-char.md) | dispatch ready |
