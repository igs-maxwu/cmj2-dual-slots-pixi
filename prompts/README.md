...
| (next) chore — Attack 衝擊感 4 大強化 (A 受擊反應 + B hit-impact burst + C damage number 升級 + G 同步 timing). AttackOptions onFireImpact callback fires Phase 4 start; spawnHitBurst (12 rays radial) + defenderHitReact (shake±6px+紅 tint 250ms) per target; popDamage 26→34pt + scale punch + 800ms. 3 atomic commits | [`chore/attack-impact-vfx-enhance.md`](chore/attack-impact-vfx-enhance.md) | dispatch ready |
