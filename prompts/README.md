...
| (next) chore — Reel ball→pentagon gem + 8 unique colors per spirit. Programmatic 5-vertex polygon (top-up) replaces circle ball. SYMBOL_VISUAL: 8 unique gem colors (4 clan × 2 sibling hues) — chore #173 same-clan-same-color spec replaced. Spirit char + ⭐ pip preserved. **SPEC drift: chore #173 → chore #198 owner-approved 2026-05-05** | [`chore/reel-ball-to-pentagon-gem.md`](chore/reel-ball-to-pentagon-gem.md) | dispatch ready |
| (next) chore — Pip indicators circle→5-point star ⭐ (RPG rarity feel). Replace `Graphics.circle(0,0,3)` with 10-vertex star polygon alternating outer R=5 / inner R=2. Tier color + count preserved. Dark outline 0.5px for legibility on bright balls | [`chore/pip-circle-to-star.md`](chore/pip-circle-to-star.md) | dispatch ready |
