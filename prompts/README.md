...
| (next) chore — DraftScreen tile widen 152→296 (uses canvas space, margin 188→52) + name moves above sprite as dedicated strip (no longer overlay covering character) | [`chore/draft-tile-wider-name-above.md`](chore/draft-tile-wider-name-above.md) | dispatch ready |
