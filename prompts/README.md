...
| (skipped) chore — Attack avatar 圓頭像 → 全身 sprite + 雙側 clash 站位. Replace SpiritPortrait(symbolId, 64) with full-body Sprite from spirit webp; add side='A'/'B' to AttackOptions; centerX clash offset (A center-70, B center+70) + facing mirror via scale.x sign; scale phases tuned for full-body. 8 signature fx preserved | [`chore/attack-anim-fullbody-clash.md`](chore/attack-anim-fullbody-clash.md) | dispatch ready |
