...
| (next, perf) chore #206 — gemBall GlowFilter lazy. Remove always-on 15 GlowFilters; rely on chore #199 dark stroke + #202 facet highlight. ~5-9ms/frame mobile fps gain. Sprint 16 cluster | [`chore/gemball-lazy-glow-filter.md`](chore/gemball-lazy-glow-filter.md) | dispatch ready |
| (next, polish) chore #207 — ROUND pill simplify. Sprint 10 the-stylist deferred audit. goldText→plain Text + double-stroke→hairlines + fontSize 14→13. Lighter HUD feel | [`chore/round-pill-simplify.md`](chore/round-pill-simplify.md) | dispatch ready |
