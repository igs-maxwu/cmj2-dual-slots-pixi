...
| (next) chore — DraftScreen tile micro-tune. Meta 12→14pt / gem r 18→24 / 玄墨 0x9a4adb→0xb567f0 (brighter for dark-text contrast). 1 commit | [`chore/draft-tile-tune-meta-gem-玄墨-color.md`](chore/draft-tile-tune-meta-gem-玄墨-color.md) | dispatch ready |
