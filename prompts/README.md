...
| (next) chore #208 — defenderHitReact on actual damage. Trigger from playDamageEvents per event (was: onFireImpact at attack zone — slot mismatch). Stronger: shake 6→10px / alpha 0.55→0.75 / duration 250→350ms / shake freq 6π→8π. Real "扣血時震動+紅閃" feel | [`chore/defender-hit-react-on-actual-damage.md`](chore/defender-hit-react-on-actual-damage.md) | dispatch ready |
