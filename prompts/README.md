...
| (next) chore — Attack clash facing invert (chore #177 hotfix r2). Owner: 雙側 clash 看到背對背. Spirit webp native faces left, current faceDir=A:+1/B:-1 leaves both facing outward. Invert to A:-1/B:+1. 1-line sign change | [`chore/attack-clash-facing-invert.md`](chore/attack-clash-facing-invert.md) | dispatch ready |
