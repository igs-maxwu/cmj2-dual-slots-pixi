...
| (next) chore — HP bar above-head → below-feet for踏板能量條 visual | [`chore/hp-bar-to-feet.md`](chore/hp-bar-to-feet.md) | dispatch ready |
| (next) s13-fx-02 — Streak multiplier fly-text + JP NT$ fly-in to wallet (sos2-fly-multiplier + sos2-particles trail; 2 new fx modules StreakFlyText.ts + JackpotFlyIn.ts) | [`sprint13/s13-fx-02-streak-fly-jp-fly-in.md`](sprint13/s13-fx-02-streak-fly-jp-fly-in.md) | dispatch ready |
