...
| [#229](https://github.com/igs-maxwu/cmj2-dual-slots-pixi/pull/229) (chore #224 polish 2) Dragon richer Chinese features — 8-layer composition (10 flame-curl mane spikes with sweep + branched antlers main stem + 2 forks each + angular face with cheekbones + bushy brows double-stroke + detailed eyes 4-layer + wide nose ellipse with 2 nostrils + open mouth with 5 teeth + 2 fangs + orange-red tongue + 6 whiskers nose-side/mouth-corner/chin-beard). Owner reference: Chinese dragon frontal painting. Merged 864694c | [`chore/meng-dragon-richer-features-rework.md`](chore/meng-dragon-richer-features-rework.md) | ✅ merged |
| [#228](https://github.com/igs-maxwu/cmj2-dual-slots-pixi/pull/228) (chore #224 polish) 孟辰璋 dragon frontal view rework — 5-layer Chinese dragon face (12-vertex mane radial spikes background + 2 antler V-shapes + 16-vertex symmetric face oval + V-mouth with 5 teeth + 2 fangs + 2 gold-iris eyes + nose ridge + 3 bezier beard whiskers, ~260×300px). Was 30-vertex side-profile (cartoon dinosaur look). Owner reference: Chinese dragon frontal painting. Merged 3409ddd | [`chore/meng-dragon-frontal-view-rework.md`](chore/meng-dragon-frontal-view-rework.md) | ✅ merged |
