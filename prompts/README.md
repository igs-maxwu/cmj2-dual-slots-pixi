...
| (next) chore — Attack 雙修：faceDir double-flip fix + centerY raise. drawFormation L967 already flips A sprite child; chore #182 chore #179 faceDir on container double-flips A. Replace faceDir with baseSign=sign(origScaleX). centerY 538 (below front row 520) → 420 (mid-formation, near VS badge 415) | [`chore/attack-faceDir-and-centerY.md`](chore/attack-faceDir-and-centerY.md) | dispatch ready |
