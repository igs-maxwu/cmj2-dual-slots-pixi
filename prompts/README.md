...
| (next) chore — DraftScreen tile 圓頭像 → 整隻 spirit 全身（mockup 蒼嵐 style）. TILE_H 152→220, SPIRIT_ZONE 150px sprite from existing /public/assets/spirits/*.webp, name 24pt overlay with clan-glow + dark outline, meta 9pt below, A/B btns bottom-aligned | [`chore/draft-screen-full-body-spirit.md`](chore/draft-screen-full-body-spirit.md) | dispatch ready |
