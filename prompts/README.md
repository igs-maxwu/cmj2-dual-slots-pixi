...
| (next) chore — Gem highlight match shape. Replace fixed ellipse highlight (球面光) with shape-aware facet: polygon (4/5/6) → inner smaller polygon offset up-left at alpha 0.35; circle (W/S/JP) keeps ellipse. 1 commit | [`chore/gem-highlight-match-shape.md`](chore/gem-highlight-match-shape.md) | dispatch ready |
