...
| (next) chore — DraftScreen tile horizontal split (name LEFT info col / sprite RIGHT col 2× taller, ~85→184px). TILE_H 185→200, info col 100W (name+meta+A/B vertical stack) / sprite col 180W full-height | [`chore/draft-tile-horizontal-split.md`](chore/draft-tile-horizontal-split.md) | dispatch ready |
