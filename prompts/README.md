...
| (next) chore — Win-line sequential trace (連連看式中獎動畫). Replace pulseWay parallel flash with column-by-column popCell + arrow connectors between adjacent columns; A azure / B vermilion; 5-col chain ~1.0s | [`chore/win-trace-sequential-arrow.md`](chore/win-trace-sequential-arrow.md) | dispatch ready |
