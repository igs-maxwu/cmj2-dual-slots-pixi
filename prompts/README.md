...
| (next) chore — Resonance banner 雙側分顯. Replace single golden centred banner with A-left-blue + B-right-red dual banners. playResonanceBanner refactor + new playSideResonanceBanner helper. x=0.27/0.73 of canvas; T.TEAM.azureGlow/vermilionGlow color. 1 commit | [`chore/resonance-banner-dual-side-color.md`](chore/resonance-banner-dual-side-color.md) | dispatch ready |
