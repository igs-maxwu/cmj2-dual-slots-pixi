...
| (next) chore — Reel gem shape by tier + ⭐ 加大. shapeFor() dispatcher: id 0-2 square ◇ / id 3-5 pentagon ⬠ / id 6-7 hexagon ⬢ / W-S-JP 圓 ⬤. Generic polygonPoints replaces pentagonPoints. starOuterR 5→7. 4 軸辨識：形狀+色+字+pip | [`chore/reel-gem-shape-by-tier.md`](chore/reel-gem-shape-by-tier.md) | dispatch ready |
