...
| (next) chore — Formation 5-slot zigzag (外內外內外). Replaces chore #180 2-row with Z-pattern: 3 spirits in outer col (rows 0/2/4) + 2 in inner col (rows 1/3). Owner-confirmed scale gradient 0.85→1.10 bottom→top. Centre clash zone 152→320px (2.1× wider). Pre-merge audit checklist | [`chore/formation-zigzag-5slot.md`](chore/formation-zigzag-5slot.md) | dispatch ready |
