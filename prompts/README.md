...
| (next) chore — Resonance banner zIndex 3500 (above fxLayer 3000) + spinColumnCenter pre-flash parallel (was sequential await → blocked center swap 290-490ms after outer/inner). Center spinMs 1320→1520 to maintain lock t≈1610. Teaser no longer delays lock | [`chore/resonance-zindex-and-center-pre-flash-parallel.md`](chore/resonance-zindex-and-center-pre-flash-parallel.md) | dispatch ready |
