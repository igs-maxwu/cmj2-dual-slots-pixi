...
Source:
- Owner mockup image: `download_picture/mockup_reference.jpg`（⚠️ 執行前 Owner 會放進來；若找不到，STOP 等 owner）
...
2. `Read download_picture/mockup_reference.jpg` — **必做**，這是 visual truth。若找不到該檔案，STOP 回報 owner 還沒放。
