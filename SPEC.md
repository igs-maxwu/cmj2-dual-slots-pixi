...
| 2026-04-23 | Spirit name canonicalization (owner): 燦瀾→蒼嵐, 殷→寅, 落落→珞洛, 照宇→朝雨, 玄沫→玄墨. Pinyin identifiers unchanged. Clan data fix: luoluo vermilion→white, zhaoyu white→black (aligns with SPEC §4 beast groupings, prerequisite for Sprint 3 M5 Resonance). | Owner |
